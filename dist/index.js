...
const deleteImageFromRegistry = ({ token, registryId, repositoryName, digest, }) => {
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield (0, cross_fetch_1.default)(`https://cr.selcloud.ru/api/v1/registries/${registryId}/repositories/${repositoryName}/${digest}`, {
            method: "DELETE",
            headers: {
...
exports["default"] = deleteImageFromRegistry;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const cross_fetch_1 = __importDefault(__nccwpck_require__(9805));
const getToken = ({ userName, selectelId, password, projectName, }) => {
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const res = yield (0, cross_fetch_1.default)("https://api.selvpc.ru/identity/v3/auth/tokens", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const getToken_1 = __importDefault(__nccwpck_require__(4869));
const listImages_1 = __importDefault(__nccwpck_require__(6522));
const deleteImage_1 = __importDefault(__nccwpck_require__(2539));
exports["default"] = {
    getToken: getToken_1.default,
    listRepositoryImages: listImages_1.default,
    deleteImageFromRegistry: deleteImage_1.default,
};
...
exports["default"] = listRepositoryImages;
...
const lib_1 = __importDefault(__nccwpck_require__(9730));
...
function run({ userName, password, projectName, selectelId, registryId, repositoryName, createdAtLessThen, minAmmountToStay, }) {
    ...
    `);
            ...
            const token = yield (0, async_retry_1.default)(() => api_1.default.getToken({
                userName,
                password,
                projectName,
                selectelId,
            }), { retries: 3 });
            (0, core_1.info)("Grab list of images for targeted repository");
            const images = yield api_1.default.listRepositoryImages({
                token,
                registryId,
                repositoryName,
            });
            ...
            let mbCleaned = imagesForDelete.reduce((p, c) => {
                ...
                1024 /
                1024;
            imagesForDelete.forEach((image) => __awaiter(this, void 0, void 0, function* () {
                (0, async_retry_1.default)(() => api_1.default.deleteImageFromRegistry({
                    token,
                    registryId,
                    repositoryName,
                    digest: image.digest,
                    ...
                    maxTimeout: 500,
                    onRetry: (e, attempt) => {
                        (0, core_1.info)(`Error occur on delete image: digest -  ${image.digest}\n`);
                        (0, core_1.info)(`message: ${e.message}\n`);
                        (0, core_1.info)(`${attempt} attemt for delete\n`);
                    },
                });
            }));
            (0, core_1.info)(`Operation is finised\n`);
            (0, core_1.info)(`${mbCleaned} MB was cleaned!`);
        }
        catch (error) {
            (0, core_1.setFailed)(error instanceof Error
                ? error.message
                : typeof error == "string"
                    ? error
